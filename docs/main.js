...
function renderFormulario() {
  ...
  if (tipo === "combustible") {
    html += '<label>Kilómetros actuales:<input type="number" id="km" /></label>';
    html += '<label>Litros cargados:<input type="number" id="litros" /></label>';
    html += '<label>Coste total (€):<input type="number" id="coste" /></label>';
  } else if (tipo === "mantenimiento" || tipo === "avería") {
